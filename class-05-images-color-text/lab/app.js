...
function sumArray(testArray){ //eslint-disable-line
  ...
  var c = testArray[2];
  var addition = sum(sum(a,b)[0],c)[0];
  var message = testArray + ' was passed in as an array of numbers, and ' + addition + ' is their sum.';
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var c = testArray[2];
  var multiplication = multiply(multiply(a,b)[0],c)[0];
  var message = 'The numbers ' + testArray + ' have a product of ' + multiplication + '.';
  return[multiplication,message];
}
